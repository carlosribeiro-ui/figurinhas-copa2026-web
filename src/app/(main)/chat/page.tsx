...
export default function ChatPage() {
          ...
          {messages.map(msg => {
            ...
            return (
              <div key={msg.id} className={`flex ${isMe ? 'justify-end' : 'justify-start'}`}>
                <div className={`max-w-xs rounded-2xl px-4 py-2.5 shadow-sm ${isMe ? 'bg-green-800 text-white rounded-br-sm' : 'bg-white text-gray-800 rounded-bl-sm'}`}>
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        <h1 className="text-2xl font-extrabold text-gray-800">Mensagens</h1>
        <p className="text-gray-500 text-sm mt-1">Conversas de trocas aceitas</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center text-gray-400 py-20">
          ...
          <p className="font-bold text-gray-600 text-lg">Nenhuma conversa ainda</p>
        ...
        <div className="space-y-2">
          {conversations.map(conv => (
            <button
              ...
              className="w-full bg-white rounded-xl border border-gray-100 shadow-sm p-4 flex items-center gap-3 hover:shadow-md hover:border-green-200 transition-all text-left"
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="font-bold text-gray-800">{conv.other_user.full_name ?? conv.other_user.username}</p>
