...
function makeTeam(
  ...
  const n   = (p: number) => `${group}${String(off + p).padStart(2, '0')}`;
  const sid = (p: number) => base + off + p;
  const sec = `GRUPO ${group}`;
  return [
    { id: sid(1), number: n(1), name: `${country} — Escudo`,         country, section: sec, type: 'team',   is_shiny: true  },
    { id: sid(2), number: n(2), name: `${country} — Foto da Equipe`, country, section: sec, type: 'team',   is_shiny: false },
    ...players.map((name, i): Sticker => ({
      id: sid(3 + i), number: n(3 + i), name, country, section: sec,
...
const FWC: Sticker[] = [
  { id:  1, number: 'FWC01', name: 'Troféu FIFA Copa do Mundo',    country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: true  },
  { id:  2, number: 'FWC02', name: 'Copa do Mundo 2026 — Logo',    country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: true  },
  { id:  3, number: 'FWC03', name: 'Mascote Oficial',              country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: false },
  { id:  4, number: 'FWC04', name: 'Estadio MetLife — EUA',        country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id:  5, number: 'FWC05', name: 'Estadio AT&T — EUA',           country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id:  6, number: 'FWC06', name: 'Estadio SoFi — EUA',           country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id:  7, number: 'FWC07', name: 'Estadio Azteca — México',      country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id:  8, number: 'FWC08', name: 'Estadio BC Place — Canadá',    country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id:  9, number: 'FWC09', name: 'Estadio Allegiant — EUA',      country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id: 10, number: 'FWC10', name: 'Estadio Arrowhead — EUA',      country: 'SEDES',    section: 'FWC', type: 'stadium', is_shiny: false },
  { id: 11, number: 'FWC11', name: 'Lenda — Pelé',                 country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 12, number: 'FWC12', name: 'Lenda — Maradona',             country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 13, number: 'FWC13', name: 'Lenda — Ronaldo Fenômeno',     country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 14, number: 'FWC14', name: 'Lenda — Zidane',               country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 15, number: 'FWC15', name: 'Lenda — Ronaldinho',           country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 16, number: 'FWC16', name: 'Lenda — Roberto Carlos',       country: 'LENDAS',   section: 'FWC', type: 'legend',  is_shiny: true  },
  { id: 17, number: 'FWC17', name: 'Seleções — Mapa Grupos',       country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: false },
  { id: 18, number: 'FWC18', name: 'Seleções — Linha do Tempo',    country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: false },
  { id: 19, number: 'FWC19', name: 'Copa 2026 — Abertura (1)',     country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: true  },
  { id: 20, number: 'FWC20', name: 'Copa 2026 — Abertura (2)',     country: 'ABERTURA', section: 'FWC', type: 'special', is_shiny: true  },
];
